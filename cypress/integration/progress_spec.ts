describe("Progress", () => {
  ...
  it("Clones a program and goes through first day", () => {
    ...
    // Testing set clicks
    cy.get("[data-cy^=excercise-]:contains('Bent Over Row') [data-cy^=set-]").first().as("firstset");
    ...
    cy.get("[data-cy^=excercise-]:contains('Bent Over Row') [data-cy^=set-]").eq(1).click();

    // Testing AMRAP set clicks
    cy.get("[data-cy^=excercise-]:contains('Bent Over Row') [data-cy^=set-]").eq(2).as("thirdSet");
    ...
    cy.get("[data-cy^=excercise-]:contains('Bent Over Row') [data-cy^=set-]").as("sets");
    ...
    cy.get("[data-cy^=excercise-]:contains('Bent Over Row') [data-cy=container-set]").as("set-containers");
    ...
    // Completing the rest excercises
