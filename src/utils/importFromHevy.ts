...
const exerciseMapping: Partial<Record<string, [string, string]>> = {
  ...
  "Single Leg Glute Bridge": ["Glute Bridge", "bodyweight"],
  "Single Leg Hip Thrust": ["Hip Thrust", "bodyweight"],
  "Single Leg Press (Machine)": ["Leg Press", "leverageMachine"],
  "Single Leg Romanian Deadlift (Barbell)": ["Romanian Deadlift", "barbell"],
  "Single Leg Romanian Deadlift (Dumbbell)": ["Romanian Deadlift", "dumbbell"],
  ...
  "Straight Arm Lat Pulldown (Cable)": ["Lat Pulldown", "cable"],
  "Straight Leg Deadlift": ["Deadlift", "barbell"],
  "Sumo Deadlift": ["Deadlift", "barbell"],
  "Sumo Squat (Barbell)": ["Squat", "barbell"],
  ...
  "Calf Extension (Machine)": ["Calf Press on Leg Press", "leverageMachine"],
  ...
  "Kneeling Push Up": ["Push Up", "bodyweight"],
  "Lateral Box Jump": ["Lateral Box Jump", "bodyweight"],
  "Lateral Lunge": ["Lunge", "barbell"],
  "Lateral Squat": ["Squat", "barbell"],
  "Leg Press Horizontal (Machine)": ["Leg Press", "leverageMachine"],
  "Leg Raise Parallel Bars": ["Knee Raise", "bodyweight"],
  ...
  "One Arm Push Up": ["Push Up", "bodyweight"],
  "One Arm Tricep Extension (Dumbbell)": ["Triceps Extension", "dumbbell"],
