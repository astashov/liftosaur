export function HtmlUtils_someInParents(
...
export function HtmlUtils_classInParents(element: Element | null, cssClass: string): boolean {
  return HtmlUtils_someInParents(element, (n) => n.classList.contains(cssClass));
}

export function HtmlUtils_selectableInParents(element: Element | null, finalElement: Element): boolean {
  return HtmlUtils_someInParents(
    element,
    (n) => {
      return (
...
export function HtmlUtils_escapeHtml(initialString: string): string {
...
export function HtmlUtils_getPointY(event: TouchEvent | MouseEvent): number {
  if ("touches" in event) {
...
export function HtmlUtils_getPointX(event: TouchEvent | MouseEvent): number {
  if ("touches" in event) {
...
export function HtmlUtils_onScrollEnd(callback: () => void, element?: HTMLElement): () => void {
