...
export const builtinProgramProperties: Partial<Record<string, IBuiltinProgramProperties>> = {
  ...
  pzerofullbody: {
    ...
    goal: "strength_and_hypertrophy",
    exercises: [
      { id: "deadlift", equipment: "barbell" },
      { id: "benchPress", equipment: "barbell" },
      { id: "tBarRow", equipment: "leverageMachine" },
      { id: "legPress", equipment: "leverageMachine" },
      { id: "chestDip", equipment: "bodyweight" },
      { id: "cableCrunch", equipment: "cable" },
      { id: "overheadPress", equipment: "barbell" },
      { id: "squat", equipment: "barbell" },
      { id: "pullUp", equipment: "bodyweight" },
      { id: "inclineBenchPress", equipment: "dumbbell" },
      { id: "seatedLegCurl", equipment: "leverageMachine" },
      { id: "bicepCurl", equipment: "dumbbell" },
      { id: "seatedRow", equipment: "cable" },
      { id: "shoulderPress", equipment: "dumbbell" },
      { id: "legExtension", equipment: "leverageMachine" },
      { id: "sideCrunch", equipment: "cable" },
      { id: "romanianDeadlift", equipment: "barbell" },
      { id: "benchPress", equipment: "dumbbell" },
      { id: "lateralRaise", equipment: "cable" },
      { id: "flatLegRaise", equipment: "bodyweight" },
    ],
    exercisesRange: [6, 6],
    equipment: ["barbell", "dumbbell", "cable", "leverageMachine"],
  },
  "gzclp-blacknoir": {
    id: "gzclp",
    frequency: 3,
