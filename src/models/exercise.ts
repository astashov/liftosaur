...
export namespace Exercise {
  ...
  export function filterExercises(allExercises: IExercise[], filter: string): IExercise[] {
    return allExercises.filter((e) => StringUtils.fuzzySearch(filter.toLowerCase(), e.name.toLowerCase()));
  }

  export function filterExercisesByType(allExercises: IExercise[], filterTypes: string[]): IExercise[] {
