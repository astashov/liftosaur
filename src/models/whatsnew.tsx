...
export function WhatsNew_all(): Record<string, IWhatsNew> {
  const whatsNew: Record<string, IWhatsNew> = {
      ...
      body: (
        <ul>
          <li>
            ...
            <a href="https://en.wikipedia.org/wiki/One-repetition_maximum">Epley formula</a> to calculate it. It's
            enabled by default, but you can disable it in settings on Graphs screen.
          </li>
        </ul>
      ),
    },
      ...
      body: (
        <ul>
          <li>
            ...
            logic for updating those, you now can "reuse logic" from other exercises. This way you can avoid repeating
            the same logic over and over again, and you'll have a single source of truth for that logic (in the exercise
            you reuse).
          </li>
          <li>
      ...
      body: (
        <ul>
          <li>
            ...
            all the sets variations (sets/reps/weight), you could see the formulas/scripts for each exercise, and
            muscles for each day and the whole program. You can use it for 2 cases:
            <ul className="pl-4 list-disc">
              <li>
              ...
              <li>
                When you build your own program, there's "Preview" footer button. If will give you high-level overview
                of the program, and could help to make sure everything works right there.
              </li>
            </ul>
          </li>
        </ul>
    ...
    "20230121": {
      ...
      body: (
        <ul>
          ...
          <li>
            The entrypoint to that screen is from the workout screen - when you tap on the exercise name, exercise
            image, or when you open the bottom sheet - there's an option "Exercise Stats"
          </li>
        </ul>
      ),
    },
    ...
    "20230222": {
      ...
      body: (
        <ul>
          ...
          <li>
            Those links are immutable - any change in the program would change the link. You can share those links if
            you want to share your program with somebody else, and they'll be able to import the program into their app.
          </li>
        </ul>
      ),
    },
    "20230224": {
      ...
      body: (
        <ul>
          ...
          <li>
            You could use it for "inspiration", to reuse some of the recipes, or come up with your own based on those.
            Or just to see what you can do with <strong>Liftoscript</strong>.
          </li>
        </ul>
      ),
    },
    ...
    "20230324": {
      ...
      body: (
        <ul>
          ...
          <li>
            You specify timer as a Liftoscript expression, similar to reps and weight, so you can define logic there
            too, and use state variables. Progressive overload in your rest timer? Why not! :)
          </li>
        </ul>
      ),
    },
    ...
    "20230409": {
      ...
      body: (
        <ul>
          <li>
            You don't need to go to the edit exercise screen to edit the state variables anymore. Now you can do it
            right from a modal that pops up when you tap "edit" icon on the exercise card, on the workout screen.
          </li>
        </ul>
      ),
    },
    ...
    "20230422": {
      ...
      body: (
        <ul>
          <li>
            Add a way to enable "quick add sets" feature for a program exercise. When enabled, there'll be a button on
            the workout screen after last set, that allows to add another set. On press, there'll be a modal, where you
      ...
      body: (
        <ul>
          <li>
            ...
            syntax errors, missing variables, and it's generally more correct. Also, it will be way easier to add
            features to it now.
          </li>
          <li>
      ...
      body: (
        <ul>
          ...
          <li>
            ...
            <strong>*=</strong> and <strong>/=</strong>. Use them like <strong>state.foo += 5lb</strong> - that'd
            increase `foo` variable by 5lb.
          </li>
        </ul>
      ),
    },
    "20230511": {
      ...
      body: (
        <ul>
          ...
          <li>
            Also, added new variable specifically for the timer expression - <code>setIndex</code>. It contains the
            index of the just completed set. You can use it to change timer based on the set number. Or to set a timer
            between exercises (<code>setIndex == numberOfSets ? 90 : 180</code>).
          </li>
        </ul>
      ),
    },
    ...
    "20230625": {
      ...
      body: (
        <ul>
          ...
          <li>
            That works both on the workout screen, and also in playgrounds on the edit program exercise screen. But on
            the playground, it won't change the program! It's just to simulate the logic if you change the sets only in
      ...
      body: (
        <ul>
          <li>
            ...
            impressing you were able to figure out how to do that in pretty large codebase, and add it in a clean and
            nice way, it's a pretty big feature. I'm really impressed!
          </li>
        </ul>
      ),
    },
      ...
      body: (
        <ul>
          ...
          <li>
            ...
            Safety Squat Bar), and assign to your exercises there. Custom equipment is properly exported into a link
            when you create a link of a program to share.
          </li>
        </ul>
      ),
    },
    "20230716": {
      ...
      body: (
        <ul>
          ...
          <li>
            Also, now you can filter by the "type" and by muscle groups. E.g. you can list all the pull exercises with
            the chest muscle group, or something like that.
          </li>
    ...
    "20230727": {
      ...
      body: (
        <ul>
          <li>
            There's a new item in Settings - "Import history from other apps". It opens a modal, where you can choose
            Hevy app, and upload CSV file - and it'll import the history from the file into Liftosaur.
          </li>
        </ul>
      ),
    },
    ...
    "20230804": {
      ...
      body: (
        <ul>
          <li>
            RPE (Rating of Perceived Exertion) now is well supported in Liftosaur. It's how hard was the exercise, on
            the scale of 0-10, where 10 is the hardest (you couldn't make any more reps){" "}
          </li>
          <li>
      ...
      body: (
        <ul>
          <li>
            ...
            looks like a bug in the app because it's unexpected, but it just tries to round the weights to your
            available equipment.
          </li>
          <li>
            So, from now on, it'll show strikethrough original weights, and the weight it was rounded to. Also, will
            show a little help message, explaining where you can adjust the equipment.
          </li>
          <li>
            The rounding logic is slightly different now - we round the weights only at the very end, during the
            workouts. State variable changes are not rounded at all.
          </li>
          <li>
    ...
    "20230831": {
      ...
      body: (
        <ul>
          ...
          <li>
            That makes it easier to create multi-week programs with mesocycles, deload weeks, 1RM testing weeks, etc.
            You can create regular days, deload days or testing RM days, and then create e.g. 6 weeks with regular days,
            and then 1 week with deload days.
          </li>
          <li>
            When multi-week mode is enabled, the program follows the order of days in weeks. I.e. when you finish a
            workout, it'll go to the next day in the week, or when it was the last day in the week - goes to the first
      ...
      body: (
        <ul>
          <li>
            ...
            on, you can specify optional <strong>Min Reps</strong> Liftoscript scripts for each set in an exercise. On
            the sets, you'll see rep ranges instead of just a single rep number.
          </li>
          <li>
          ...
          <li>
            If the min reps are enabled and provided, you'll have them available in the <strong>minReps</strong>{" "}
            variable in the Finish Day scripts. If they're not enabled or provided, they'll use <strong>reps</strong>{" "}
            (i.e. max reps) variable values. For example, you don't have min reps for the first set, but max reps are{" "}
      ...
      body: (
        <ul>
          <li>
            ...
            programs would be there, and it will just sync the data next time when Internet is available if you're
            logged in.
          </li>
        </ul>
      ),
    ...
    "20231016": {
      ...
      body: (
        <ul>
          <li>
            It used to be that when you edit a program in a web editor, it'd update the link right in the URL bar, and
            the short links like /p/123abc would just redirect to the long links with whole program presented into a
            URL.
          </li>
          <li>
            But apprently there's 10K limit in the URL length, so it was breaking for some large programs. So, I had to
            change how it works. Now, when you edit a program, you need to generate a link to "Save" it, each change
            won't automatically update the browser history. It'll also show a warning (that you can close) when you
            change a linked program that in order to "Save" the changes, you need to generate a new link that'll
            represent a changed program.
          </li>
        </ul>
      ),
    },
    ...
    "20231225": {
      ...
      body: (
        <ul>
          ...
          <li>
            It should be especially useful for the Web Editor, before it was sometimes pretty tricky to understand if
            your program works properly, especially if it has a bunch of set variations. There was Exercise-level
            Playground, but wasn't Program-level Playground, and now there is!
          </li>
        </ul>
      ),
    },
      ...
      body: (
        <ul>
          ...
          <li>
            ...
            create a week, you type a week name from a new line, starting with a hash sign. Like{" "}
            <strong># Week 1</strong>. To create a week - same thing, just starting with 2 hash signs, like{" "}
            <strong>## Day 1</strong>.
          </li>
    ...
    "20240106": {
      ...
      body: (
        <ul>
          <li>
            1RM would be reused across programs, and is tied to exercise themselves, not programs. You still can access
            it in the Liftoscript scripts via <strong>rm1</strong> variable, and you can set it in the Finish Day Script
            too.
          </li>
          <li>
          ...
          <li>
            You can edit 1RM on the Exercise Stats screen (when you tap on the exercise name on the workout screen).
            Also, it'll show up on the "Edit" modal (when you tap on the Edit icon on the working screen) in case it was
            used anywhere in the program exercise scripts.
          </li>
    ...
    "20240127": {
      ...
      body: (
        <ul>
          ...
          <li>
            The syntax got extended with the new features, making it pretty much as powerful as a regular way of
            building programs. You now can use Liftoscript within the new syntax to describe the progressions.
          </li>
          <li>
            Basically, the new programs is just one blob of text, and it changes over time based on your progressions.
            You can define set variations, quick add sets, descriptions, ways to switch between them, etc - everything
            is possible!
          </li>
          <li>
    ...
    "20240205": {
      ...
      body: (
        <ul>
          <li>
            Now you can dynamically make updates in reps, sets or weights. Like for example, if you want to have AMRAP
            on the first set, and then based on the completed reps of that set adjust the reps of the rest sets, you can
            do it now. Do something like:
  ...
  ~}`}
          ...
          <li>
            In that script, you may change <strong>reps</strong>, <strong>minReps</strong>, <strong>weights</strong>,
            and <strong>RPE</strong> variables. It doesn't change a program, and you cannot access state variables, but
            you can access any other built-in variable.
          </li>
          <li>
    ...
    "20240318": {
      title: (
        <span>
          Redesigned exercise picker and ability to replace exercises from the workout and new editor screens.
        </span>
      ),
      body: (
        <ul>
          <li>
            There's a new exercise picker modal, that now combines equipment selection + exercise selection, and also
...
~}`}
    ...
    "20240413": {
      ...
      body: (
        <ul>
          <li>
            For the old programs, it was pretty convenient to just change <strong>state.weight</strong> state variable
            to adjust the weight across the sets of the exercise.
          </li>
          <li>
          ...
          <li>
            ...
            screen. It lists all the weights used by the exercise in a program, and you can quickly adjust them, either
            by typing, or by buttons, and there's also a Rep Max Calculator for convenience.
          </li>
        </ul>
      ),
    },
...
~}`}
      ...
      body: (
        <ul>
          <li>
            ...
            the AMRAP modal) have "rich" inputs for reps, weight and RPE. They have buttons allowing to adjust the
            values, weight inputs have a Rep Max Calculator, and the buttons increment and decrement various values
            properly.
          </li>
          <li>
            For example, it'd increment/decrement weights according to available equipment - getting next possible
            weight with your plates. And for reps - it increments by 1, and for RPE - by 0.5
          </li>
        </ul>
      ),
    },
    "20240506": {
      ...
      body: (
        <ul>
          ...
          <li>
            ⚠️ This is a breaking change though! ⚠️ If you use this feature, you likely would need to change your
            program to enable it across all weeks/days where you want to have it, not only the first week/day of the
            exercise!!!
          </li>
        </ul>
      ),
    ...
    "20240525": {
      ...
      body: (
        <ul>
          ...
          <li>
            You can still switch to the plain text mode by tapping on <IconDoc />, and adjust the program text. Also,
            for the Web Editor the plain text mode is still the main way of editing programs.
          </li>
          <li>
      ...
      body: (
        <ul>
          ...
          <li>
            <ul className="ml-4 list-disc">
              <li>
                It was confusing for new users to <strong>pick the equipment AND exercise name</strong>. The fact that
                you need to pick equipment first, and then tap on the exercise name, even if you just want to change the
                equipment for the current exercise was very weird.
              </li>
              <li>
                <strong>Equipment was tied to the available plates</strong>. So, if you wanted to change bar/plates
                (like to a different barbell) - but keep the old ones - you'd get a new exercise, with the new history,
                graphs, etc - which sometimes was undesirable.
              </li>
            </ul>
          </li>
          ...
          <li>
            Equipment is separated from the exercise now, and it defines only the plates/bar/fixed weights. You can
            attach equipment to your exercises, and that will be used for rounding and plates calculator - but that's
            optional!
          </li>
          ...
          <li>
            ...
            <strong>Standard Barbell</strong> with 35lb bar, and a different set of plates. Or don't attach any
            equipment - and just specify the default rounding - but in that case you won't have plates calculated.
          </li>
          ...
          <li>
            It also changes how custom exercises work. You cannot choose equipment for custom exercises anymore - only
            the name. So, if you had custom exercises with different equipment or even custom equipment - they will be
          ...
          <li>
            ...
            new gym but don't attach equipment from it to exercises. In that case they'd just use default rounding,
            which could be good enough for travelling - you probably don't want to enter all the equipment details for
            temporary gyms.
          </li>

          <li>
            I know I say that a lot, but - that's a very big new feature, so could be bugs - so don't hesitate to email
            me at <strong>info@liftosaur.com</strong> or contact via Discord/Reddit if there're issues!
          </li>
        </ul>
      ),
    },
      ...
      body: (
        <ul>
          <li>
            ...
            necessary (that actually changed) data. Hopefully it'll make the data sync faster and more reliable.
            There're also some user-facing changes related to that:
          </li>
          <li>
            <ul className="ml-4 list-disc">
              <li>
      ...
      body: (
        <ul>
          <li>
            ...
            on the Web you change a program in the app (e.g. by finishing a workout, or changing a program weight) -
            then the changes from the app will overwrite the changes from the Web.
          </li>
          <li>
            That could be super frustrating. So as a way to fix that, I'm adding{" "}
            <strong>Program Version History</strong>.
          </li>
          <li>
            ...
            that opens a modal with all the snapshots), and restore any of the past snapshots. I'll store up to 100
            recent snapshots.
          </li>
          <li>
      ...
      body: (
        <ul>
          ...
          <li>
            ...
            has "Lat Pulldown" cable machine in kgs - it makes sense to specify weights in kg for Lat Pulldown, and set
            it to the kg-based equipment.
          </li>
        </ul>
      ),
    },
    "20240922": {
      ...
      body: (
        <ul>
          <li>
            You can now pause the workout, by tapping the pause button in the workout screen header. It'll stop the
            total workout timer.
          </li>
    ...
    "20241103": {
      ...
      body: (
        <ul>
          <li>
            Now you can change <strong>numberOfSets</strong> in the progress scripts. So, sets based progressions just
            got way easier to do. Before you had to use either <strong>numsets</strong> state variable + update script,
            or use multiple set variations. Now you can just do <strong>numberOfSets = 4</strong> or{" "}
          ...
          <li>
            ...
            <strong>update</strong> scripts - if you add sets, it'll add them the same as the last set you had before.
            So, most of the time you don't need to pair it with the <strong>sets()</strong>
          ...
          <li>
            In <strong>progress</strong> scripts you can also specify what week/day/set variation specifically you want
            to change number of sets for, by doing <strong>numberOfSets[week:day:setvariation] = 3</strong>, for
            example:
    ...
    "20241109": {
      ...
      body: (
        <ul>
          <li>
            Now all the newly cloned programs will be automatically converted to the unit (kg or lb) you have selected
            in Settings. And if you import a program via link, and it has different units from the Settings one, it'll
            ask you if you want to convert into the Settings units.
          </li>
    ...
    "20241117": {
      ...
      body: (
        <ul>
          ...
          <li>
            Added big bold "Start" and "Continue" buttons to the start workout card, because some new users were
            confused how to start a workout.
          </li>
        </ul>
      ),
    },
    "20241130": {
      ...
      body: (
        <ul>
          ...
          <li>
            It's pretty much the same as "Week Stats" on the Program screen, but for the actual week - it'll show how
            many sets total, hypertrophy/strength split, sets per muscle group you did with the workouts that week.
          </li>
          <li>
    ...
    "20241207": {
      ...
      body: (
        <ul>
          ...
          <li>
            It's mostly useful if you keep forgetting to finish it, and then you open it in like 5 hours, and it syncs
            to Apple/Google Health, and your calories stats go crazy.
          </li>
          <li>
    ...
    "20241214": {
      ...
      body: (
        <ul>
          ...
          <li>
            You can do that through UI, or in the full program mode you just add comments above the day or week,
            similarly how you do that for the exercises. Like:
          </li>
          <li>
            <div className="m-2 overflow-x-auto">
              <PlannerCodeBlock
...
Squat / 5x5 / progress: lp(5lb)`}
    ...
    "20250210": {
      ...
      body: (
        <ul>
          ...
          <li>
            At the top there's week calendar now, that you can swipe left and right to change the week. If you tap it -
            it opens monthly calendar.
          </li>
    ...
    "20250304": {
      ...
      body: (
        <ul>
          <li>
            I rewrote the Liftoscript engine from the ground up, to simplify it and remove the dependency on the
            old-style programs. It's now way easier to add new features to it, but that also means I'm replacing a
            system that was battle-tested for years with a new one. So, there could be bugs.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <ul className="pl-4 list-disc">
              ...
              <li>
                For "template" exercises (the <strong>/ used: none /</strong> ones) it's not required to have a custom
                or built-in exercise matching the name anymore. So, you can name your templates like <strong>T1</strong>{" "}
                or something like that, and don't create custom exercises with <strong>T1</strong> name.
              </li>
              <li>
                If you reuse <strong>progress: custom()</strong>, you don't have to list all the state variables again
                in the reusing <strong>progress: custom()</strong> arguments. They will be inherited, you only need to
                list the ones that have different value from the original ones.
              </li>
    ...
    "20250330": {
      ...
      body: (
        <ul>
          ...
          <li>
            The <strong>Target</strong> column contains the requirements for the set - from the program. We still use
            the same color coding to distinguish between success sets (green), failed sets (red) and in-range sets
            (yellow).
          </li>
          ...
          <li>
            ...
            <strong>completedWeights</strong> array var (used to be in <strong>weights</strong>).{" "}
            <strong>weights</strong>
            now contains the program weights. There's automated migration that should run and theoretically you don't
            need to do anything, but check your scripts to make sure it looks good.
          </li>
        </ul>
      ),
    },
      ...
      body: (
        <ul>
          ...
          <li>
            ...
            vertically (scrolling the workouts) - not as convenient. Also, it used to be nice to see the currently
            ongoing workout on the top of the screen - that was removed with per-week workouts.
          </li>
          <li>
...
Squat / 3x8 100lb / ...main`}
    ...
    "20250424": {
      ...
      body: (
        <ul>
          <li>
            It now has filters (by frequency, duration of a workout, experience, etc) to help you find a suitable
            program.
          </li>
          <li>
    ...
    "20250607": {
      ...
      body: (
        <ul>
          <li>
            Made the structure more logical - now there're very prominent tabs for Editing and for Playground, and also
            4 icons/tabs to switch between sorting, UI mode, per day code mode and full code mode.
          </li>
          <li>
            Also, when you edit a program exercise - it navigates to a separate "Edit Program Exercise" screen. On that
            screen you can edit everything related to the exercise - sets, warmups, descriptions, as well as progress
            and update logic.
          </li>
          <li>
            So from now on, everything you could do in the full text mode is pretty much possible to do via UI,
            including custom progressions and updates.
          </li>
          <li>
      ...
      body: (
        <ul>
          <li>
            ...
            your program in Liftoscript. It combines all the documentation and a bunch of examples into that huge
            prompt, and you can copy it, and paste into AI or your choice, and it'll generate a program for you.
          </li>
          <li>
...
~}`}
    ...
    "20250622": {
      ...
      body: (
        <ul>
          <li>
            Now there's a <strong>bodyweight</strong> variable that would return the latest bodyweight moving average
            from <strong>Measurements</strong> screen. You can use it e.g. for pull ups or some other bodyweight
            exercises.
            <div className="m-2 overflow-x-auto">
              <PlannerCodeBlock
...
~}`}
      ...
      body: (
        <ul>
          <li>
            ...
            notice any changes, and hopefully it'll prevent rare cases when the app doesn't data sync properly between
            the web editor, web app, and phone app.
          </li>
          <li>
    ...
    "20250810": {
      ...
      body: (
        <ul>
          ...
          <li>
            So, now you can define a bunch of unused exercises you may want to switch to (e.g. if some machines are
            often busy in your gym - you can define alternatives), and quickly add / replace them during the workout.
          </li>
          <li>
          ...
          <li>
            ...
            exercise (and then you set up the sets yourself), or you add program exercise, and it behaves like you
            defined it in the program.
          </li>
        </ul>
      ),
    },
    "20250813": {
      ...
      body: (
        <ul>
          <li>
            Now you can hide the built-in equipment you don't have / not going to use on the "Available Equipment"
            screen.
          </li>
          <li>
            Also <strong>POTENTIALLY BREAKING CHANGE</strong> - if you never ever set the equipment for some exercises,
            it will be automatically set to matching equipment now. E.g. the exercise is{" "}
          ...
          <li>
            Did that because there was a lot of confusion for new users - like why they set up Barbell equipment, but
            it's not applied to barbell exercises by default.
          </li>
        </ul>
      ),
    },
    "20250826": {
      ...
      body: (
        <ul>
          ...
          <li>
            Let me know if some colors look weird or contrast is bad - info@liftosaur.com, or our Discord or
            /r/liftosaur subreddit.
          </li>
        </ul>
      ),
    },
    ...
    "20250904": {
      ...
      body: (
        <ul>
          <li>
            They allow to mark a set AMRAP, ask for actual RPE after completing a set or ask for actual weight.
            Basically the same as adding <strong>+</strong> after appropriate value.
          </li>
          <li>
...
~}`}
    ...
    "20250905": {
      ...
      body: (
        <ul>
          <li>
            It used to be ephemeral like Playground, but it's non obvious that it behaves that way. Also, seems like a
            lot of people go there after cloning a program, so this is the place where they'd expect to configure
            equipment and 1RMs.
          </li>
          <li>
    ...
    "20250914": {
      ...
      body: (
        <ul>
          ...
          <li>
            Those are not tied to a program, those are associated with exercises or equipment. You can use exercise
            notes to e.g. list form cues for a specific exercise, and the equipment notes to e.g. list tweaks of
            equipment, e.g. bench angle, cable setup, etc.
          </li>
          ...
          <ul className="pl-4 list-disc">
            ...
            <li>
              <strong>Exercise notes</strong> - those would be not tied to a program, but to an exercise. You can use
              them to add general notes for the exercise, e.g. form cues. You can edit them on the Exercise Stats
              screen.
            </li>
            <li>
      ...
      body: (
        <ul>
          ...
          <li>
            <ul className="pl-4 list-disc">
              <li>
                People noted it's hard to add target/synergist muscles because you don't know on the top of your head
                what muscles exercise works, and from what muscle group each muscle is. So now:
              ...
              <li>
                You can <strong>clone from existing</strong> built-in (or existing custom) exercises, and it will
                prefill the image, the muscles and the types of the cloned exercise to your custom one.
              </li>
            </ul>
          </li>
          <li>
            There's one <strong>breaking change</strong> though - you won't be able to specify URLs of images anymore
            for custom exercises. It was a temporary hack (which survived for like 2 years!), and external images
            sometimes don't work if you generate workout or program images. It still will work for existing exercises,
            but you won't be able to change their image URLs anymore. You can only change the image there by uploading a
            new one, or picking from a library.
          </li>
        </ul>
      ),
    },
      ...
      body: (
        <ul>
          <li>
            ...
            the estimated 1 Rep Max for the set. Would be semi-transparent for non-completed set, and solid for
            completed set. It uses completed reps/weight/RPE for calculation, but if not available yet - uses target
            reps/weight/RPE.
          </li>
        </ul>
      ),
    ...
    "20251013": {
      ...
      body: (
        <ul>
          <li>
            If you disagree with the built-in target/synergist muscles of some exercise, you can now override them! Go
            to the Exercise Stats screen (e.g. from Me - Exercises), and tap on "Override Muscles" at the very top. You
            can choose the muscles and the multiplier there. If it's <strong>1</strong> - it's a target muscle, if less
            than 1 - it's a synergist muscle. This will be taken into account in the week insights, in the week volume
            stats on the Program screen, on the graphs, etc.
          </li>
        </ul>
      ),
    },
    "20251101": {
      ...
      body: (
        <ul>
          <li>
            Now you can add exercises to superset groups, and within that group it will switch between exercises each
            time you finish a workout set. E.g. if you have 3 exercises in a superset group, you'd do 1 set of the first
          ...
          <li>
            You can set those groups both in a program and in a workout. In a program, you can do it both in the text
            and UI. In the text, it looks like this:
            <div className="m-2 overflow-x-auto">
              <PlannerCodeBlock
...
Bent Over Row / 3x8 / superset: A`}
          ...
          <li>
            The supersets will be highlighted by a colored line on the bottom side of exercise thumbnails during
            workout, as well as within the exercise card.
          </li>
        </ul>
      ),
    },
    ...
    "20251109": {
      ...
      body: (
        <ul>
          ...
          <li>
            The volume is calculated by summing up reps from both sides. The e1RM is calculated by taking the average
            from reps of both sides.
          </li>
        </ul>
      ),
    },
    "20251123": {
      ...
      body: (
        <ul>
          <li>
            On the lock screen, it'll show Live Activity, with the timer, next exercise, set, reps, weights, plates,
            etc.
          </li>
    ...
    "20251125": {
      ...
      body: (
        <ul>
          ...
          <li>You can adjust the rest timer from there, or complete a set.</li>
          <li>
            There's also rest timer in the little chip near the clock, which is shown if you're currently in another
            app.
          </li>
          <li>
            It's a <strong>Premium feature</strong>, so you'd need to have Premium subscription to use it.
      ...
      body: (
        <ul>
          <li>
            ...
            the <strong>lp</strong> and <strong>dp</strong> behave weird. They consider the program weight as 0lb, add
            5lb to it, and the program weight becomes 5lb. But user may entered e.g. 100lb there for each set, and then
            they see 5lb as the weight next time, and got confused.
          </li>
          <li>
    ...
    "20260120": {
      ...
      body: (
        <ul>
          <li>
            Previously, if you start a workout e.g. on a phone, and then open a webapp, you won't be able to see it
            there. The ongoing workout would only exist locally, and syncs to the server when you finish it.
          </li>
          <li>
    ...
    "20260124": {
      ...
      body: (
        <ul>
          <li>
            Previously, the workout would sync to Apple or Google health when you tap "Continue" on the
            "Congratulations" screen. But some users never did that, exiting the app right after they finished a
            workout, so the workout never got synced to Apple/Google Health.
          </li>
          <li>
          ...
          <li>
            You can also submit past workouts to Apple/Google Health - if you open a past workout, and tap the share
            icon - there'll be an option to "Sync to Apple/Google Health".
          </li>
        </ul>
      ),
    },
    "20260129": {
      ...
      body: (
        <ul>
          <li>
            If you have Premium and iPhone, you can now use Liftosaur on your Apple Watch to track your workouts. You
            can complete sets, see rest timers, view upcoming exercises, etc. You cannot modify the workout though (like
          ...
          <li>
            That was a huge and complex project, so definitely let me know if you notice any bugs or issues - in
            Discord, Reddit, or by{" "}
            <a className="font-bold underline text-text-link" href="mailto:info@liftosaur.com">
              info@liftosaur.com
            </a>
          </li>
    ...
    "20260222": {
      ...
      body: (
        <ul>
          <li>
            Not the app, but the site update. There's now the /programs page on the liftosaur.com site, where you can
            find all the programs available in the app, along with full description (pros/cons, program philosophy, how
            to run it, etc), preview, Liftoscript code, etc.
          </li>
          <li>
