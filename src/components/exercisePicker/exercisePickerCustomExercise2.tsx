    ...
    <div className="flex flex-col h-full" style={{ marginTop: "-0.75rem" }}>
      ...
      <div className="flex-1 pb-4 overflow-y-auto">
        ...
        <div className="px-4 pt-2">
          ...
          <div className="pt-2">
            <ExercisePickerCustomExerciseTypes types={typeValues} />
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="w-full">
      ...
      <div onClick={() => setIsOpened(true)}>
        <ExercisePickerCustomExercise2SelectInput selectedValues={ObjectUtils.keys(props.types)} />
      </div>
      {isOpened && (
        <BottomSheet
        ...
        >
          <div className="flex flex-col h-full px-4">
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="pb-4">
                <ExercisePickerOptions values={props.types} onSelect={(key) => {}} />
              </div>
            </div>
          </div>
        </BottomSheet>
      ...
      {isOpened && (
        ...
        >
          <div className="flex flex-col h-full px-4">
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="pb-4">
                <ExercisePickerOptionsMuscles selectedValues={[]} onSelect={(key) => {}} />
              </div>
            </div>
          </div>
        </BottomSheet>
