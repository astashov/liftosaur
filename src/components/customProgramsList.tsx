...
import { IEquipment, IProgram, ISettings } from "../types";
...
function CustomProgram(props: ICustomProgramProps): JSX.Element {
  ...
  return (
    ...
    >
      <div
        className="absolute z-0 flex items-center gap-1 px-2 py-1 leading-none border rounded-full bg-grayv3-50 border-grayv3-200"
      ...
      >
        ...
        <button
          ...
          onClick={() => {
            if (props.programs.length < 2) {
              alert("You cannot delete all your programs, you should have at least one");
            } else if (props.editProgramId == null || props.editProgramId !== props.program.id) {
