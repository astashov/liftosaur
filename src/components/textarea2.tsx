...
export const Textarea2 = forwardRef((props: IProps, ref: Ref<HTMLTextAreaElement>): JSX.Element => {
  const { labelElement, changeHandler, errorMessage, patternMessage, ...otherProps } = props;
