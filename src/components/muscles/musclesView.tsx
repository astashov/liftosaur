...
export function MusclesView(props: IMusclesViewProps): JSX.Element {
  return (
    <Tabs2
      tabs={[
        ["Strength", <MusclesTypeView type="strength" points={props.points} settings={props.settings} />],
        ["Hypertrophy", <MusclesTypeView type="hypertrophy" points={props.points} settings={props.settings} />],
      ]}
    />
  );
}
...
function MusclesTypeView(props: IMusclesTypeViewProps): JSX.Element {
