        ...
        >
          ...
          >
            <div className="relative flex items-center flex-1">
              {!props.isHidden && (
                <WorkoutShareImage history={props.history} record={props.record} settings={props.settings} />
              )}
            </div>
            ...
            <div className="relative flex items-center flex-1">
              {!props.isHidden && (
                <WorkoutShareImage
                  ...
                  onPickCustomBg={async () => {
                    setShowPickerOptions(true);
                  }}
                />
              )}
            </div>
            <h2 className="pt-2 pb-4 text-base text-center">Your photo as background</h2>
          </div>
        </div>
      </div>
        ...
        <div ref={workoutShareRef} style={{ width: "420px" }}>
          {props.type === "igstory" ? (
            ...
            <WorkoutShareOutputWithBg
              ...
              record={props.record}
              settings={props.settings}
              backgroundImage={selectedFrameIndex === 1 ? backgroundImage : "/images/workoutsharebg.jpg"}
            />
          ) : null}
        </div>
      </div>
