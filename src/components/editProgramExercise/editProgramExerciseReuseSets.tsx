  ...
  return (
    <View>
      ...
      <Pressable
        ...
        data-testid="edit-exercise-reuse-sets"
        ...
        <View className="flex-row gap-4 px-4 mb-2">
          ...
          {reuse &&
            (isOverriding ? (
              <LinkButton
                className="text-sm"
                data-testid="edit-exercise-remove-override-sets"
                testID="edit-exercise-remove-override-sets"
              ...
              <LinkButton
                ...
                data-testid="edit-exercise-override-sets"
                testID="edit-exercise-override-sets"
                onClick={() => {
                  props.plannerDispatch(
