...
export function HelpChooseProgram(): JSX.Element {
  return (
    <>
      ...
      <p className="pb-2">
        Each pre-built program has <strong>tags</strong>, which define the style of the program. Like, whether it's
        assumes you have access to <strong>barbell</strong>, or <strong>dumbbell</strong> only, whether it's{" "}
