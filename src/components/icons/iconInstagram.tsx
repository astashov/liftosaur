...
export function IconInstagram(props: IProps): JSX.Element {
  const size = props.size ?? 40;

  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width={size} height={size} viewBox="0 0 256 256">
      <defs></defs>
      <g style={gStyle} transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)">
        <linearGradient
          id="SVGID_3"
        ...
        <path
          ...
          style={{ ...pathStyle, fill: "url(#SVGID_3)" }}
        ...
        <path
          ...
          style={{ ...pathStyle, fill: "url(#SVGID_4)" }}
          transform=" matrix(1 0 0 1 0 0) "
          strokeLinecap="round"
        />
        <linearGradient
          ...
          y2="74.8394"
        >
          <stop offset="0%" stopColor="rgb(243,0,114)" stopOpacity={1} />
          <stop offset="100%" stopColor="rgb(229,0,151)" stopOpacity={1} />
        </linearGradient>
        <path
          ...
          style={{ ...pathStyle, fill: "url(#SVGID_5)" }}
          transform=" matrix(1 0 0 1 0 0) "
          strokeLinecap="round"
        />
      </g>
