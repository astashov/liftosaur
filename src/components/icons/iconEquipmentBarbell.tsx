...
export function IconEquipmentBarbell(props: IIconEquipmentBarbellProps): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke-miterlimit="10"
      />
      <path d="M-1 12.053L2.98113 12.053" stroke-width="2" stroke-miterlimit="10" />
      <path d="M9.5 12L25 12" stroke-width="2" stroke-miterlimit="10" />
    </svg>
  );
}
