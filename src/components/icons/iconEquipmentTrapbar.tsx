...
interface IIconEquipmentTrapbarProps {
  size?: number;
  color?: string;
  className?: string;
}

export function IconEquipmentTrapbar(props: IIconEquipmentTrapbarProps): JSX.Element {
  ...
  return (
    ...
    >
      ...
      />
      <path d="M14.1411 4.45044L19.5496 9.85897" stroke-width="1.5" stroke-linecap="round" />
      <path d="M4.44971 14.1409L9.85824 19.5494" stroke-width="1.5" stroke-linecap="round" />
    </svg>
  );
}
