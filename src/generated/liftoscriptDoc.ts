// Auto-generated from ./llms/liftoscript.md
...
Checks if each element in the first array is either zero or greater than or equal to the corresponding element in the second array. Useful for checking if all non-skipped sets met the rep target.
