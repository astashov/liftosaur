...
export function AiContent(props: IAiContentProps): JSX.Element {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      for await (const event of service.convertProgramWithAiStream(input)) {
    ...
    <section className="flex flex-col h-screen max-w-full mx-auto">
      ...
      <div className="flex flex-col flex-1 overflow-hidden md:flex-row">
        ...
        <div className="flex flex-col flex-1 p-4">
          ...
          {retryCount > 0 && (
            <div className="p-2 mb-2 text-sm text-blue-700 bg-blue-50 border border-blue-200 rounded">
