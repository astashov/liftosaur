...
const editorSetup: Extension[] = [
  ...
  autocompletion({
    ...
    addToOptions: [
      {
        render: (completion) => {
          const exercise = Exercise.findByName(completion.label, {});
          const url =
      ...
      },
      {
        render: (completion) => {
          ...
          const synergistMuscles = Exercise.synergistMuscles(exercise, {});
          ...
          const synergistMuscleGroupsNode = buildInfoLine(
            ...
            Exercise.synergistMusclesGroups(exercise, {})
...
export class PlannerEditor {
  ...
  public attach(container: HTMLElement): void {
    ...
    const language = buildPlannerExerciseLanguageSupport();
    ...
    const editorState = EditorState.create({
      doc: this.args.value || "",
      extensions: [keymap.of(defaultKeymap), editorSetup, updateFacet, language, eventHandlers],
    });
