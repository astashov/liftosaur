      ...
      <div className="flex flex-col flex-1 min-h-0 sm:flex-row">
        ...
        >
          <div className="my-2 text-center">
            <Button name="export-program-picture" kind="orange" className="w-32" onClick={() => save()}>
              {isLoading ? <IconSpinner width={12} height={12} color="white" /> : "Export"}
            </Button>
          </div>
          <GroupHeader size="large" name="Export program to picture" />
          <MenuItemEditable
          ...
          <div>
            <span className="mr-2">
              <LinkButton name="select-all" onClick={() => setConfig({ ...config, daysToShow: initialDaysToShow })}>
                Select All
              </LinkButton>
            </span>
