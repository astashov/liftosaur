...
export function PlannerWeek(props: IPlannerWeekProps): JSX.Element {
  ...
  const [showProgramDescription, setShowProgramDescription] = useState(!!props.week.description?.trim());
  return (
    <div key={props.weekIndex} className="flex flex-col md:flex-row">
      <div className="flex-1">
        ...
        {props.week.days.map((day, dayIndex) => {
          const lastDayDescription = PlannerProgram.getLastDayDescription(
            props.program.weeks,
            props.weekIndex,
            dayIndex
          );
          return (
            <div key={dayIndex}>
              <PlannerDay
                ...
                lastDayDescription={lastDayDescription}
