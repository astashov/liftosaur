    ...
    autocomplete: (context: CompletionContext) => {
      ...
      if (stateVar != null) {
        ...
        return completeFromList([
          ...
          { label: "originalWeights", type: "keyword liftoscript" },
          ...
          { label: "amraps", type: "keyword liftoscript" },
          { label: "logrpes", type: "keyword liftoscript" },
          { label: "askweights", type: "keyword liftoscript" },
          { label: "timers", type: "keyword liftoscript" },
          { label: "setTime", type: "keyword liftoscript" },
          ...
          { label: "completedSetTime", type: "keyword liftoscript" },
          { label: "setVariationIndex", type: "keyword liftoscript" },
          { label: "exerciseVariationIndex", type: "keyword liftoscript" },
          { label: "bodyweight", type: "keyword liftoscript" },
          ...
          { label: "roundConvertWeight", type: "function liftoscript" },
