...
- Any workout program is fully customizable - you can clone existing one and adjust to your needs. Every single program is written using Liftoscript right in the app, so every bit of it could be changed.
...
- Custom exercises.
- Social features - friends, likes, comments, sharing your workout results.
