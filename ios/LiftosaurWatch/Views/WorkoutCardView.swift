    ...
    WorkoutCardView(
        ...
        exercises: [
            WatchExercise(id: "benchPress_barbell", name: "Bench Press", imageUrl: "/externalimages/exercises/single/small/benchpress_barbell_single_small.png", sets: [
                WatchSet(index: 0, reps: 5, minReps: nil, weight: nil, originalWeight: nil, isAmrap: false, askWeight: nil, rpe: nil, timer: nil, label: nil, isCompleted: false, completedReps: nil, completedRepsLeft: nil, completedWeight: nil, completedRpe: nil, status: "not-finished", plates: nil, isWarmup: false, isUnilateral: false),
                WatchSet(index: 1, reps: 5, minReps: nil, weight: nil, originalWeight: nil, isAmrap: false, askWeight: nil, rpe: nil, timer: nil, label: nil, isCompleted: false, completedReps: nil, completedRepsLeft: nil, completedWeight: nil, completedRpe: nil, status: "not-finished", plates: nil, isWarmup: false, isUnilateral: false),
                WatchSet(index: 2, reps: 5, minReps: nil, weight: nil, originalWeight: nil, isAmrap: true, askWeight: nil, rpe: nil, timer: nil, label: nil, isCompleted: false, completedReps: nil, completedRepsLeft: nil, completedWeight: nil, completedRpe: nil, status: "not-finished", plates: nil, isWarmup: false, isUnilateral: false)
            ]),
