        ...
        workout: WatchWorkout(
            ...
            exercises: [
                WatchExercise(id: "benchPress_barbell", name: "Bench Press", imageUrl: "/externalimages/exercises/single/small/benchpress_barbell_single_small.png", sets: [
                    WatchSet(index: 0, reps: 5, minReps: nil, weight: WatchWeight(value: 45, unit: "lb"), originalWeight: WatchWeight(value: 42.5, unit: "lb"), isAmrap: false, askWeight: nil, rpe: nil, timer: nil, setTimer: nil, label: nil, isCompleted: true, completedReps: nil, completedRepsLeft: nil, completedWeight: nil, completedRpe: nil, completedSetTimer: nil, status: "success", plates: "45", isWarmup: false, isUnilateral: false),
                    WatchSet(index: 1, reps: 5, minReps: nil, weight: WatchWeight(value: 45, unit: "lb"), originalWeight: WatchWeight(value: 42.5, unit: "lb"), isAmrap: false, askWeight: nil, rpe: nil, timer: nil, setTimer: nil, label: nil, isCompleted: true, completedReps: nil, completedRepsLeft: nil, completedWeight: nil, completedRpe: nil, completedSetTimer: nil, status: "in-range", plates: "45", isWarmup: false, isUnilateral: false),
                    WatchSet(index: 2, reps: 5, minReps: nil, weight: WatchWeight(value: 45, unit: "lb"), originalWeight: WatchWeight(value: 42.5, unit: "lb"), isAmrap: true, askWeight: nil, rpe: nil, timer: nil, setTimer: nil, label: nil, isCompleted: false, completedReps: nil, completedRepsLeft: nil, completedWeight: nil, completedRpe: nil, completedSetTimer: nil, status: "not-finished", plates: "45", isWarmup: false, isUnilateral: false)
                ]),
                WatchExercise(id: "overheadSquat_barbell", name: "Overhead Squat", imageUrl: "/externalimages/exercises/single/small/overheadsquat_barbell_single_small.png", sets: [
                    WatchSet(index: 0, reps: 5, minReps: nil, weight: WatchWeight(value: 45, unit: "lb"), originalWeight: WatchWeight(value: 77.5, unit: "lb"), isAmrap: false, askWeight: nil, rpe: nil, timer: nil, setTimer: nil, label: nil, isCompleted: true, completedReps: nil, completedRepsLeft: nil, completedWeight: nil, completedRpe: nil, completedSetTimer: nil, status: "failed", plates: nil, isWarmup: false, isUnilateral: false),
